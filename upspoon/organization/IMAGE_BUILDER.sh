...
#Tag Image
echo "Add Tag"
docker tag upspoon-organization:latest 980605516176.dkr.ecr.us-east-1.amazonaws.com/upspoon-organization:latest
sleep 5
...
echo "Push Image"
docker push 980605516176.dkr.ecr.us-east-1.amazonaws.com/upspoon-organization:latest
