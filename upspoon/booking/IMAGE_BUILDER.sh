...
#Tag Image
echo "Add Tag"
docker tag upspoon-booking:latest your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-booking:latest
sleep 5
...
echo "Push Image"
docker push your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-booking:latest
