...
#Tag Image
echo "Add Tag"
docker tag upspoon-authorization-user:latest your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-authorization-user:latest
sleep 5
...
echo "Push Image"
docker push your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-authorization-user:latest
