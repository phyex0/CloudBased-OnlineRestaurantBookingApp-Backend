...
#Tag Image
echo "Add Tag"
docker tag upspoon-stock:latest your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-stock:latest
sleep 5
...
echo "Push Image"
docker push your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-stock:latest
