...
public interface RestaurantUserClient {
    ...
    @PostMapping(value = "/api/restaurant-user", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/api/restaurant-user", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "/api/restaurant-user", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Deletes the given user")
    ResponseEntity<Void> deleteUser(@RequestParam(value = "userId") UUID userId);

    @PutMapping(value = "/api/restaurant-user", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/api/restaurant-user/find-by-mail", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<RestaurantUserDTO> findUserByMail(@RequestParam String mail);
}
