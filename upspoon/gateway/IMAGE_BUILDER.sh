...
#Tag Image
echo "Add Tag"
docker tag upspoon-gw:latest your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-gw:latest
sleep 5
...
echo "Push Image"
docker push your-arn.dkr.ecr.us-east-1.amazonaws.com/upspoon-gw:latest
